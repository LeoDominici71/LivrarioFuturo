...
public class Program {
	...
	public static void main(String[] args) {
		...
		Livro livro  = new Livro("Malala, a menina que queria ir para a escola", "Adriana Carranca", 21.9, TipoPromocaoEnum.valueOf("B"));
		Livro livro1 = new Livro("A revolução dos bichos: Um conto de fadas", "George Orwell", 8.5, TipoPromocaoEnum.valueOf("A"));
