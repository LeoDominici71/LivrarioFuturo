...
public class Program {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// seed para promocao
			list.add(new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/20"), livro,
					TipoPromocaoEnum.valueOf("B"), 10));
			list.add(new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/15"), livro1,
					TipoPromocaoEnum.valueOf("A"), 5));
			list.add(new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/20"), livro2,
					TipoPromocaoEnum.valueOf("B"), 10));
			list.add(new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/15"), livro3,
					TipoPromocaoEnum.valueOf("A"), 5));
			list.add(new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/15"), livro4,
					TipoPromocaoEnum.valueOf("A"), 5));
			list.add(new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/30"), livro5,
					TipoPromocaoEnum.valueOf("C"), 15));
			list.add(new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/15"), livro6,
					TipoPromocaoEnum.valueOf("A"), 5));
			list.add(new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/30"), livro7,
					TipoPromocaoEnum.valueOf("C"), 15));
