...
public class DescontoTests {
	...
	public void DescontoTestingA() {
		...
		DetalhePromocao detP = new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/15"), livroTest,
				TipoPromocaoEnum.valueOf("A"), DescontoFactory.PctDescontoA);
	...
	public void DescontoTestingB() {
		...
		Livro livroTest = DescontoFactory.createEmptyLivro(price);
		DetalhePromocao detP = new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/20"), livroTest,
				TipoPromocaoEnum.valueOf("B"), DescontoFactory.PctDescontoB);
		List<DetalhePromocao> list = new ArrayList<>();
		detP.desconto(detP.getTipo(), livroTest, detP.getPctPromocao());
		Assertions.assertEquals(expectedValue, detP.desconto(detP.getTipo(), livroTest, detP.getPctPromocao()));
	...
	public void DescontoTestingC() {
		...
		Livro livroTest = DescontoFactory.createEmptyLivro(price);
		DetalhePromocao detP = new DetalhePromocao(new Date("2023/01/10"), new Date("2023/01/30"), livroTest,
				TipoPromocaoEnum.valueOf("C"), DescontoFactory.PctDescontoC);
		List<DetalhePromocao> list = new ArrayList<>();
		detP.desconto(detP.getTipo(), livroTest, detP.getPctPromocao());
		Assertions.assertEquals(expectedValue, detP.desconto(detP.getTipo(), livroTest, detP.getPctPromocao()));
